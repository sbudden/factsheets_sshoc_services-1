...
This folder contains all static pages belonging to the https://github.com/subugoe/factsheets_sshoc_services. They are all written in [Markdown](https://daringfireball.net/projects/markdown/).
...
The markdown files are later rendered as html within the SSHOC static docs site <https://subugoe.github.io/factsheets_sshoc_services> identified as `pagename.html`.
